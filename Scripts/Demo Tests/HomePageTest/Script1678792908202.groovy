...
WebUI.callTestCase(findTestCase('Demo Tests/Login'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('Object Repository/Page_Orders  nopCommerce administration/a_Logout'))
